...
CASES = [
    ...
    ("listed large PIE above 500 employees, below the new thresholds",
     ...
     {"FY2024": "yes", "FY2025": "depends", "FY2026": "depends", "FY2027": "no", "FY2028": "no"}, "FY2024", {"derogation"}),
    ...
    ("becomes large in FY2024 only: Art. 3(10) keeps the earlier category that year",
     ...
     {"FY2024": "no", "FY2025": "depends", "FY2026": "depends", "FY2027": "no"}, None, {"derogation"}),
    ("falls below in FY2025: still large for FY2025 under Art. 3(10), not for FY2026",
     ...
     non_eu([fy(2023, to=60 * M, emp=600, bst=30 * M), fy(2024, to=60 * M, emp=600, bst=30 * M),
            ...
            listed_on_eu_regulated_market=True, only_debt_securities_min_denomination_eur_100000=False),
     {"FY2024": "yes", "FY2025": "depends", "FY2026": "no"}, "FY2024", {"derogation"}),
    ("EU listed PIE that is large only from FY2024: Art. 3(10) against Art. 40",
     "Art. 3(10); Art. 40 (PIE treated as large)",
    ...
    ("listed SME with 300 employees: never in scope",
     "Art. 5(2) first subpara. (c) deleted by Dir. 2026/470 Art. 3(1)(a)(iii); (a)(i) needs > 500 employees",
     eu(years(dict(to=60 * M, emp=300, bst=40 * M), 2023, 2024, 2025), listed_on_eu_regulated_market=True),
    ...
    ("insurance undertaking below the thresholds: in the 2024 set, out from FY2027",
     ...
     {"FY2024": "yes", "FY2025": "depends", "FY2027": "no"}, "FY2024", {"derogation"}),
    ...
    ("not a PIE, but a Member State designation would change FY2024-2026",
     "Art. 2(1)(d) Dir. 2013/34/EU",
     eu(years(BIG, 2023, 2024)),
     {"FY2024": "no", "FY2027": "yes"}, "FY2027", {"designated-pie"}),
]
...
class DirectiveTable(Isolated):
    ...
    def test_missing_prior_year_is_reported_as_a_fact_needed(self):
        ...
        self.assertEqual(statuses(res)["FY2027"], "yes")
